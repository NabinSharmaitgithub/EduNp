...
export default function DirectoryClient({ staff, classes, subjects, error }: Props) {
  ...
  return (
    <div className="max-w-content mx-auto w-full">
      <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
        <h1 className="text-headline-lg">Staff Directory</h1>
        <div className="flex gap-2">
          <Link href="/admin/import" className={btnOutline}><Icon name="upload_file" /> Import CSV</Link>
