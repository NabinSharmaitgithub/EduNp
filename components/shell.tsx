...
const NAV: { label: string; href: string; icon: string; roles: UserProfile['role'][] }[] = [
  { label: 'Analytics', href: '/admin', icon: 'analytics', roles: ['principal'] },
  { label: 'Classes', href: '/classes', icon: 'school', roles: ['principal', 'teacher'] },
  { label: 'Staff', href: '/admin/staff', icon: 'people', roles: ['principal'] },
