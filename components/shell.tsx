...
const NAV: { label: string; href: string; icon: string; roles: UserProfile['role'][] }[] = [
  ...
  { label: 'Classes', href: '/classes', icon: 'school', roles: ['principal'] },
  ...
  { label: 'Assignments', href: '/admin/assignments', icon: 'assignment_ind', roles: ['principal'] },
  { label: 'Attendance', href: '/admin/attendance', icon: 'event_available', roles: ['principal'] },
  { label: 'Timetable', href: '/admin/timetable', icon: 'schedule', roles: ['principal'] },
  { label: 'Fees', href: '/admin/fees', icon: 'payments', roles: ['principal'] },
  { label: 'Announcements', href: '/admin/announcements', icon: 'campaign', roles: ['principal'] },
  { label: 'Exams', href: '/admin/exams', icon: 'quiz', roles: ['principal'] },
